...
<div class="report-info alert alert-info" style="margin-bottom: 15px;">
    <strong>Total de gerentes evaluados:</strong> {{totalUsuarios}} | 
    ...
    <table class="report-matrix table table-bordered" style="min-width: 1200px; font-size: 11px;">
            ...
            <tr class="categoria-row header-row">
                <th class="th-main-header" rowspan="3">
                    <div class="logo-container">
                        <img src="client/img/century21-logo.png" alt="C21" style="width: 40px; height: 40px;">
                    </div>
                </th>
                {{#each @root.preguntas}}
        ...
        <tbody>
            ...
            <tr class="usuario-row">
                ...
                {{#each this}}
                {{#each this}}
                <td class="celda-respuesta color-{{getCeldaColor ../../../userId id}}">
                </td>
                {{/each}}
                {{/each}}
                {{/each}}
                
                <!-- Columna de totales por usuario -->
...
<div class="no-data text-center" style="margin: 50px 0;">
    <div class="alert alert-warning">
        ...
        <p>No se encontraron encuestas de gerentes completadas.</p>
    </div>
</div>
{{/if}}

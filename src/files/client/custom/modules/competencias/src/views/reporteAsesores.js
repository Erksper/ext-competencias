define(['view'], function (View) {
    ...
    return View.extend({
        ...
        template: 'competencias:reporteAsesores',
        ...
        setup: function () {
            console.log('📊 Configurando reporte de asesores');
        ...
        cargarDatosReporte: function () {
            console.log('🔍 Cargando datos del reporte de asesores...');
            
            // Cargar preguntas para asesores
        ...
        procesarPreguntas: function (preguntas) {
            console.log('🔄 Procesando', preguntas.length, 'preguntas para asesores...');
